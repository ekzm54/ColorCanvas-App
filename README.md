...
No product features are implemented yet — see `docs/sprints/Sprint-Index.md` in the Docs repository for what comes next (Sprint 004 — Home Screen, the first sprint gated by an RFC).